...
% 각 구간 상대유전율 및 길이 설정
e1 = 8.14; e2 = 12; e3 = 8.14; e4 = 1; e5 = 8.14;
m1 = 0.5; m2 = 0.5; m3 = 1; m4 = 0.5; m5 = 0.5;
c = 3e8;
v1 = c / sqrt(e1);
v2 = c / sqrt(e2);
v3 = c / sqrt(e3);
...
Ez = h5read('case16_220MHz.out', '/rxs/rx1/Ez');
iteration = 6785;
Time = 80e-9;
...
scatter(t_calculation4,y_t_calculation4,100,[0.4940 0.1840 0.5560],"filled")
