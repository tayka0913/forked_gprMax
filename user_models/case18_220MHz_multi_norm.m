...
figure;
subplot(6, 1, 1);
plot(time, case18_220MHz_A_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx1에서 수신된 신호');

subplot(6, 1, 2);
plot(time, case18_220MHz_B_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx2에서 수신된 신호');

subplot(6, 1, 3);
plot(time, case18_220MHz_C_20cm_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx3에서 수신된 신호');
hold on;
hold off;
subplot(6, 1, 4);
plot(time, case18_220MHz_C_50cm_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx3에서 수신된 신호');
hold on;
hold off;
subplot(6, 1, 5);
plot(time, case18_220MHz_D_20cm_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx3에서 수신된 신호');
hold on;
hold off;
subplot(6, 1, 6);
plot(time, case18_220MHz_D_50cm_normalized, 'r', 'LineWidth', 2);
xlabel('Time (s)');
ylabel('Ez');
% title('rx3에서 수신된 신호');
hold on;
