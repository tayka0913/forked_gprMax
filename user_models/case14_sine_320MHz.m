...
Ez = h5read('case14_sine_320MHz.out', '/rxs/rx1/Ez');
iteration = 25440;
Time = 300e-9;
...
% 수신2 생성
end_index2 = find(time <= 80e-9, 1, 'last'); % 10 ns의 인덱스 찾기
Eztr2= Eztr;
Eztr2(1:end_index2) = 0;
% 수신3 생성
end_index3 = find(time <= 100e-9, 1, 'last'); 
Eztr3= Eztr;
...
end_index2 = find(time <= 80e-9, 1, 'last'); 
